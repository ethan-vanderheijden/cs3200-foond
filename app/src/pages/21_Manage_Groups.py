...
st.session_state.page = st.sidebar.selectbox(
    "Go to", ["Professor Home", "Manage Groups", "Generate Group Recommendations", "About"], index=0
)

if st.session_state.page == "Professor Home":
    st.write("What would you like to do today?")
    if st.button("Manage Groups"):
        st.session_state.page = "Manage Groups"
    if st.button("Generate Group Recommendations"):
        st.session_state.page = "Generate Group Recommendations"
...
if st.session_state.page == "Manage Groups":
    ...
    st.header("About")
    st.write(
        "This is the Food Finder App developed to assist different personas in managing their dining experiences."
    )
